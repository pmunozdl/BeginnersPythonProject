#importar un txt con todas las palabras en castellano
#seleccionar una palabra random de ese fichero. Poner un input para determinar el número de letras
#algoritmo para jugar al ahorcado una vez tenga la palabra


#video: https://www.youtube.com/watch?v=t5UHiXcYD8Y&ab_channel=MoureDevTV
import re
import random
archivo = open("spanish.txt")
def ahorcado(archivo):
    numeroletras = input ("selecc¡ona el número de letras de la palabra:")
    print(numeroletras)
    #algoritmo para seleccionar las palabras
    archivo = archivo.read()
    words = archivo.split()
    print(len(words))
    resultado = random.choice(words)
    print(resultado)
ahorcado(archivo)
# import os
# import random
